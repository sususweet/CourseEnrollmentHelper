...
var updatelogs="";
	//if (localStorage["Beta"]==1){
		checkurl="http://115.159.96.65/alienrollment/update/";
	//}
	//else {
	//}
	$.get(chrome.extension.getURL('manifest.json'), function(info){
		...
		success:function(data){	
			...
			if (version>nowver){
				...
				//alert("小阿狸要更新啦啦啦~点击确定下载！主人记得安装哦！！\n\n当前版本："+nowver+"\n\n最新版本："+version+"\n\n更新日志：\n"+updatelogs);
...
　　url: "http://115.159.96.65/alienrollment/permit.php?uid="+localStorage["Stu"]+"&type=1&ver="+nowver,
　　timeout : 3000,
　　type : 'GET',
	dataType:'json',
	async:false,
...
var opt={
	type:"basic",
	title:"小阿狸选课",
	message:"小阿狸已经完成主人交给的任务了呢~\(^o^)/！现在主人可以很方便地选课啦~",
